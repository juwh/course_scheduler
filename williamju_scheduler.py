...
Purpose: Additional testing as included with the grading process
Valid plan found: Yes
Wait time estimate: < 1 seconds

9. Goal: [("CS", "mathematics")]
   Initial: []
...
{Course(program='AADS', designation='1001') CourseInfo(credits='1', terms=('Spring', 'Junior'), prereqs=())
Course(program='AADS', designation='1010') CourseInfo(credits='3', terms=('Spring', 'Junior'), prereqs=())
Course(program='AADS', designation='1706') CourseInfo(credits='3', terms=('Spring', 'Junior'), prereqs=())
Course(program='AADS', designation='3850') CourseInfo(credits=3, terms=('Spring', 'Junior'), prereqs=())
Course(program='CS', designation='1101') CourseInfo(credits='3', terms=('Spring', 'Junior'), prereqs=())
Course(program='AADS', designation='1506') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=())
Course(program='AADS', designation='2166') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=())
Course(program='AADS', designation='2168') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=())
Course(program='CS', designation='2201') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=(('CS', '1101'),))
Course(program='AADS', designation='2214') CourseInfo(credits='3', terms=('Spring', 'Senior'), prereqs=())
Course(program='AADS', designation='4979') CourseInfo(credits='3', terms=('Spring', 'Senior'), prereqs=())
...
Course(program='AADS', designation='2214') CourseInfo(credits='3', terms=('Spring', 'Sophomore'), prereqs=())
...
Course(program='MATH', designation='2810') CourseInfo(credits='3', terms=('Spring', 'Sophomore'), prereqs=(('MATH', '2300'),))
Course(program='ENGL', designation='1250W') CourseInfo(credits='3', terms=('Fall', 'Junior'), prereqs=())
...
Course(program='ARTS', designation='1102') CourseInfo(credits='3', terms=('Spring', 'Junior'), prereqs=())
...
Course(program='PSY', designation='1200') CourseInfo(credits='3', terms=('Spring', 'Junior'), prereqs=())
...
Course(program='SOC', designation='3702') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=())
Course(program='ARTS', designation='2101') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=(('ARTS', '1102'),))
Course(program='CS', designation='3259') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=(('CS', '2201'), ('MATH', '2400')))
Course(program='CS', designation='3270') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=(('CS', '2231'),))
...
Course(program='ASTR', designation='1020L') CourseInfo(credits='1', terms=('Spring', 'Senior'), prereqs=())
...
Course(program='EES', designation='1001') CourseInfo(credits='1', terms=('Spring', 'Senior'), prereqs=())
Course(program='CS', designation='writingrequirement') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('AMER', '1002W'),))
Course(program='CS', designation='liberalother') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('ARTS', '1102'), ('ARTS', '2101')))
Course(program='CS', designation='open1') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('ASTR', '1020L'),))
Course(program='CS', designation='open2') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('ASTR', '1020L'),))
Course(program='CS', designation='open3') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('ASTR', '1020L'),))
Course(program='CS', designation='open4') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('ASTR', '1020L'),))
Course(program='CS', designation='open5') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('ASTR', '1020L'),))
Course(program='CS', designation='open6') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('ASTR', '1020L'),))
...
Course(program='CS', designation='techelectives1') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('EES', '1001'),))
Course(program='CS', designation='techelectives2') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('EES', '1001'),))
...
Course(program='MATH', designation='2500') CourseInfo(credits='4', terms=('Fall', 'Frosh'), prereqs=())
Course(program='MATH', designation='1200') CourseInfo(credits='3', terms=('Spring', 'Frosh'), prereqs=())
Course(program='MATH', designation='1300') CourseInfo(credits='4', terms=('Spring', 'Frosh'), prereqs=())
Course(program='JAPN', designation='1102') CourseInfo(credits='5', terms=('Spring', 'Frosh'), prereqs=(('JAPN', '1101'),))
Course(program='MATH', designation='2501') CourseInfo(credits='4', terms=('Spring', 'Frosh'), prereqs=(('MATH', '2500'),))
...
Course(program='MATH', designation='2420') CourseInfo(credits='3', terms=('Fall', 'Sophomore'), prereqs=(('MATH', '2501'),))
Course(program='MATH', designation='2820') CourseInfo(credits='3', terms=('Fall', 'Sophomore'), prereqs=(('MATH', '2501'),))
Course(program='BSCI', designation='1100') CourseInfo(credits='3', terms=('Spring', 'Sophomore'), prereqs=())
Course(program='EUS', designation='2203') CourseInfo(credits='3', terms=('Spring', 'Sophomore'), prereqs=())
Course(program='CS', designation='2201') CourseInfo(credits='3', terms=('Spring', 'Sophomore'), prereqs=(('CS', '1101'),))
...
Course(program='MATH', designation='2300') CourseInfo(credits='3', terms=('Fall', 'Junior'), prereqs=(('MATH', '1301'),))
Course(program='ARTS', designation='1102') CourseInfo(credits='3', terms=('Spring', 'Junior'), prereqs=())
Course(program='BSCI', designation='1100L') CourseInfo(credits='1', terms=('Spring', 'Junior'), prereqs=())
Course(program='PSY', designation='1200') CourseInfo(credits='3', terms=('Spring', 'Junior'), prereqs=())
Course(program='CS', designation='3281') CourseInfo(credits='3', terms=('Spring', 'Junior'), prereqs=(('CS', '2231'), ('CS', '3251')))
...
Course(program='CS', designation='liberalhum') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('ENGL', '1250W'), ('EUS', '2203')))
Course(program='CS', designation='esintro') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('ES', '1401'), ('ES', '1402'), ('ES', '1403')))
Course(program='CS', designation='calculus') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('MATH', '1300'), ('MATH', '1301'), ('MATH', '2500'), ('MATH', '2501')))
Course(program='CS', designation='mathelective') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('MATH', '2420'),))
Course(program='CS', designation='statsprobability') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('MATH', '2820'),))
Course(program='CS', designation='liberalsoc') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('PSY', '1200'), ('SOC', '3702')))}
...
{Course(program='AADS', designation='1001') CourseInfo(credits='1', terms=('Spring', 'Sophomore'), prereqs=())
Course(program='AADS', designation='1010') CourseInfo(credits='3', terms=('Spring', 'Sophomore'), prereqs=())
Course(program='AADS', designation='1706') CourseInfo(credits='3', terms=('Spring', 'Sophomore'), prereqs=())
Course(program='AADS', designation='3850') CourseInfo(credits=3, terms=('Spring', 'Sophomore'), prereqs=())
Course(program='MATH', designation='1200') CourseInfo(credits='3', terms=('Spring', 'Sophomore'), prereqs=())
Course(program='AADS', designation='1506') CourseInfo(credits='3', terms=('Fall', 'Junior'), prereqs=())
Course(program='AADS', designation='2166') CourseInfo(credits='3', terms=('Fall', 'Junior'), prereqs=())
Course(program='AADS', designation='2168') CourseInfo(credits='3', terms=('Fall', 'Junior'), prereqs=())
Course(program='MATH', designation='1201') CourseInfo(credits='3', terms=('Fall', 'Junior'), prereqs=(('MATH', '1200'),))
Course(program='AADS', designation='1016') CourseInfo(credits='3', terms=('Spring', 'Junior'), prereqs=())
Course(program='AADS', designation='2214') CourseInfo(credits='3', terms=('Spring', 'Junior'), prereqs=())
Course(program='AADS', designation='4979') CourseInfo(credits='3', terms=('Spring', 'Junior'), prereqs=())
Course(program='MATH', designation='1301') CourseInfo(credits='4', terms=('Spring', 'Junior'), prereqs=(('MATH', '1201'),))
Course(program='AADS', designation='2178') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=())
Course(program='AADS', designation='2294') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=())
Course(program='AADS', designation='3214') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=())
Course(program='MATH', designation='2300') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=(('MATH', '1301'),))
Course(program='MATH', designation='1300') CourseInfo(credits='4', terms=('Spring', 'Senior'), prereqs=())
Course(program='CS', designation='mathematics') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('CS', 'calculus'), ('CS', 'statsprobability'), ('CS', 'mathelective')))
Course(program='CS', designation='calculus') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('MATH', '1300'), ('MATH', '1301'), ('MATH', '2300'), ('MATH', '2410')))
Course(program='MATH', designation='2410') CourseInfo(credits='3', terms=('Spring', 'Senior'), prereqs=(('MATH', '2300'),))
Course(program='MATH', designation='2420') CourseInfo(credits='3', terms=('Spring', 'Senior'), prereqs=(('MATH', '2300'),))
Course(program='MATH', designation='2810') CourseInfo(credits='3', terms=('Spring', 'Senior'), prereqs=(('MATH', '2300'),))
Course(program='CS', designation='mathelective') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('MATH', '2420'),))
Course(program='CS', designation='statsprobability') CourseInfo(credits='0', terms=('Spring', 'Senior'), prereqs=(('MATH', '2810'),))
...
Course(program='ES', designation='1403') CourseInfo(credits='1', terms=('Fall', 'Sophomore'), prereqs=())
Course(program='MATH', designation='1201') CourseInfo(credits='3', terms=('Fall', 'Sophomore'), prereqs=(('MATH', '1200'),))
Course(program='MATH', designation='2420') CourseInfo(credits='3', terms=('Fall', 'Sophomore'), prereqs=(('MATH', '2501'),))
Course(program='MATH', designation='2820') CourseInfo(credits='3', terms=('Fall', 'Sophomore'), prereqs=(('MATH', '2501'),))
Course(program='BSCI', designation='1100') CourseInfo(credits='3', terms=('Spring', 'Sophomore'), prereqs=())
Course(program='BSCI', designation='1100L') CourseInfo(credits='1', terms=('Spring', 'Sophomore'), prereqs=())
Course(program='EUS', designation='2203') CourseInfo(credits='3', terms=('Spring', 'Sophomore'), prereqs=())
Course(program='JAPN', designation='1011') CourseInfo(credits='3', terms=('Spring', 'Sophomore'), prereqs=())
Course(program='CS', designation='2201') CourseInfo(credits='3', terms=('Spring', 'Sophomore'), prereqs=(('CS', '1101'),))
Course(program='MATH', designation='1301') CourseInfo(credits='4', terms=('Spring', 'Sophomore'), prereqs=(('MATH', '1201'),))
Course(program='ENGL', designation='1250W') CourseInfo(credits='3', terms=('Fall', 'Junior'), prereqs=())
Course(program='SOC', designation='3702') CourseInfo(credits='3', terms=('Fall', 'Junior'), prereqs=())
Course(program='CS', designation='2231') CourseInfo(credits='3', terms=('Fall', 'Junior'), prereqs=(('CS', '2201'),))
Course(program='CS', designation='3251') CourseInfo(credits='3', terms=('Fall', 'Junior'), prereqs=(('CS', '2201'),))
Course(program='JAPN', designation='1012') CourseInfo(credits='3', terms=('Fall', 'Junior'), prereqs=(('JAPN', '1011'),))
Course(program='MATH', designation='2300') CourseInfo(credits='3', terms=('Fall', 'Junior'), prereqs=(('MATH', '1301'),))
Course(program='ARTS', designation='1102') CourseInfo(credits='3', terms=('Spring', 'Junior'), prereqs=())
Course(program='PSY', designation='1200') CourseInfo(credits='3', terms=('Spring', 'Junior'), prereqs=())
Course(program='CS', designation='3281') CourseInfo(credits='3', terms=('Spring', 'Junior'), prereqs=(('CS', '2231'), ('CS', '3251')))
Course(program='JAPN', designation='1102') CourseInfo(credits='5', terms=('Spring', 'Junior'), prereqs=(('JAPN', '1012'),))
Course(program='MATH', designation='2400') CourseInfo(credits='4', terms=('Spring', 'Junior'), prereqs=(('MATH', '2300'),))
Course(program='CS', designation='2212') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=())
Course(program='ARTS', designation='2101') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=(('ARTS', '1102'),))
Course(program='CS', designation='3259') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=(('CS', '2201'), ('MATH', '2400')))
Course(program='CS', designation='3270') CourseInfo(credits='3', terms=('Fall', 'Senior'), prereqs=(('CS', '2231'),))
Course(program='CS', designation='4959') CourseInfo(credits='1', terms=('Fall', 'Senior'), prereqs=(('CS', '3281'),))
Course(program='JAPN', designation='2201') CourseInfo(credits='5', terms=('Fall', 'Senior'), prereqs=(('JAPN', '1102'),))
Course(program='AMER', designation='1002W') CourseInfo(credits='3', terms=('Spring', 'Senior'), prereqs=())
Course(program='ASTR', designation='1020L') CourseInfo(credits='1', terms=('Spring', 'Senior'), prereqs=())
Course(program='CS', designation='1151') CourseInfo(credits='3', terms=('Spring', 'Senior'), prereqs=())
Course(program='EECE', designation='2116') CourseInfo(credits='3', terms=('Spring', 'Senior'), prereqs=())
